                        ...
                        <form action="profile.php" method="GET">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-light border-0" value="John Doe">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-secondary-custom small">Phone Number</label>
                                    <input type="tel" class="form-control bg-light border-0" value="01712345678">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-secondary-custom small">Institution Name</label>
                                    <input type="text" class="form-control bg-light border-0" value="Ideal School & College">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-secondary-custom small">Class / Level</label>
                                    <input type="text" class="form-control bg-light border-0" value="Class 10">
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-bold text-secondary-custom small">Current Address</label>
                                    <input type="text" class="form-control bg-light border-0" value="Dhanmondi, Dhaka">
                                </div>
