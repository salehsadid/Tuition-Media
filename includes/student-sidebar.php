...
$sidebarUnreadCount = $sidebarDb->fetchOne("SELECT COUNT(*) as cnt FROM ST_NOTIFICATION WHERE target_role = 'student' AND user_id = :u_id AND is_read = 0", ['u_id' => $_SESSION['user_id']])['cnt'] ?? 0;
?>
