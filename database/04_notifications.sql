...
BEGIN
    -- Get the student's user_id from the post
...
-- Trigger B: Student Approves/Rejects Application -> Notify Tutor
...
-- Trigger C: Successful Connection -> Notify Admin
...
-- Trigger D: Student Registers -> Notify Admin
...
-- Trigger E: Tutor Registers -> Notify Admin
